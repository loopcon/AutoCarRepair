    ...
    <div class="container-fluid p-0">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{route('admin_shopping-update')}}" id="ourservice-form" enctype="multipart/form-data" data-parsley-validate="">
                            ...
                            <div class="row">
                                ...
                                <textarea class="form-control" id="extra_meta_description" name="extra_meta_description" value="{{ isset($record->extra_meta_description) ? $record->extra_meta_description : old('extra_meta_description') }}" placeholder="{{__('Extra Meta Tag')}}">{{ isset($record->extra_meta_description) ? $record->extra_meta_description : old('extra_meta_description') }}</textarea>

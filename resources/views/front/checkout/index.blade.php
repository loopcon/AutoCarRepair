            ...
            <div class="personal-detail-main">
                <h4>Personal Details</h4>
                    ...
                    <div class="mb-3 d-none" id="vehicle">
                        <input type="text" class="form-control alphanumeric" id="vehicle_number" name="vehicle_number" maxlength="15" aria-describedby="emailHelp" placeholder="Vehicle Number" value="{{ Auth::guard('user')->check() ? Auth::guard('user')->user()->vehicle_number : ''}}">
                    </div>

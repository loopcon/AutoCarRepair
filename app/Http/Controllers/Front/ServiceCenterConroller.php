...
class ServiceCenterConroller extends MainController
{
    public function index()
    {
        ...
        $service_center = Seo::select('meta_title','meta_keyword','meta_description','extra_meta_description','canonical_tag')->where('id', Constant::SERVICE_CENTER_SEO_ID)->first();
        ...
        $return_data['canonical_tag'] =  isset($service_center->canonical_tag) && $service_center->canonical_tag ? $service_center->canonical_tag : NULL;

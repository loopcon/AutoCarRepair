...
//        $google_client->setClientSecret('SECRET');*/
        ...
        $hsetting = HomePageSetting::select('section1_title1', 'section1_title2', 'section1_image', 'section1_description','image_title', 'meta_title', 'meta_keywords', 'meta_description','canonical_tag', 'extra_meta_tag','price_list')->where('id', 1)->first();
        $return_data['hsetting'] = $hsetting;
        $return_data['offer_slider'] = OfferSlider::select('id', 'title1', 'title2', 'image','image_title', 'btn_link', 'btn_title')->orderBy('reorder', 'ASC')->get();
